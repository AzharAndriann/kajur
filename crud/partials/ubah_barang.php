            ...
            <div class="panel-body">
                <form class="form-horizontal" method="POST" action="../controller/proses_ubah_barang.php">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="harga_beli" autocomplete="off" value="<?php echo $nama_barang; ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="harga_jual" autocomplete="off" value="<?php echo $nama_barang; ?>" required>
                        </div>
                    </div>
