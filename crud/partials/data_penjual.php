...
<div class="row mt-4">
    <div class="col-md-12 mt-5 float-right">
        <div class="page-header">
            <h4 class="mb-3">Data Detail Jual</h4>
                <div class="pull-right btn-tambah">
                    <form class="form-inline" method="POST" action="tampil_data_penjual.php">
    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4>Data Detail Jual
                    <a class="btn btn-info" href="tambah_data_penjual.php">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $query = mysqli_query($db, "SELECT tb_detail_jual.kd_penjualan, tb_detail_jual.kd_barang, tb_detail_jual.jumlah_jual, tb_detail_jual.sub_total_harga
                                FROM tb_detail_jual
                                WHERE NOT EXISTS (
                                    SELECT 1 FROM tb_penjualan
                                    WHERE tb_penjualan.kd_penjualan = tb_detail_jual.kd_penjualan)")
                                ...
                                while ($data = mysqli_fetch_assoc($query)) {
                                    ...
                                    <td width='150'> $data[kd_barang]</td>
                                    <td width='150'> $data[jumlah_jual]</td>
                                    <td width='120'> $data[sub_total_harga]</td>

                                    <td width='100'>
                                        <div class=''>
                                         <a data-toggle='tooltip' data-placement='top' title='ubah_detail'
                                         style='margin-right:5px' class = 'btn btn-info btn-sm'
                                         href='?page=ubah_detail&id=$data[kd_penjualan]'>
                                         <i class='bi bi-pencil-square text-light'></i></a>";
                            ?>

                                        <a data-toggle="tooltip" data-placement="top" title="Hapus"
                                        class="btn btn-danger btn-sm" href="../controller/proses_hapus_data_penjual.php?id=<?php echo $data['kd_penjualan'];?>" onclick="return confirm('Anda yakin ingin menghapus barang <?php echo $data['kd_penjualan'];?>?');">
